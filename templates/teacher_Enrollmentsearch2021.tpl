            ...
            <div class="row">
                <div class="btn-group">
                    <a class="btn btn-primary" href="teacher_studentprofileadd2021.php?search=add" role="button">Add
                        Student</a>&nbsp;&nbsp;&nbsp;
                    <a class="btn btn-primary" href="teacher_studentsearch2021.php?search=all"
                        role="button">All</a>&nbsp;&nbsp;&nbsp;
                    <a class="btn btn-primary" href="teacher_studentsearch2021.php?search=active"
                        role="button">Active</a>&nbsp;&nbsp;&nbsp;
                    <a class="btn btn-primary" href="teacher_studentsearch2021.php?search=notactive" role="button">Not
                        Active</a>&nbsp;&nbsp;&nbsp;
                </div>
                <!-- Recent Sales -->
                <div class="col-12">
