                    ...
                    <div class="card recent-sales">
                        ...
                        <div class="card-body">
                            <h5 class="card-title">Student List <span>| Today - {$todaydate}</span>
                                ...
                                <p class="small fst-italic">Click to <a
                                        href="teacher_lunchsummaryreport2021.php?teacherno={$teacherno}&search={$searchtype}&grade={$grade}&date={$date}"
                                        target="_blank">Print</a> Lunch Summary by Grade Report
                                </p>

                                <p class="small">Select Grade Filter - {$gradebuttons} </p>

                                <form action="teacher_Cafeteriasearch2021.php" method="post" id="tab_date">
                        ...
                        <form action="teacher_Cafeteriasearch2021.php" method="post" id="tab_SUBMIT">
