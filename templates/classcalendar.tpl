...
<body>
    <div id="cal-wrap">
        ...
        <div style="width: 800px; overflow: hidden;">
            ...
            <div id="cal-date">
                <select id="cal-mth" hidden></select>
                <select id="cal-yr" hidden></select>
            </div>
...
<script>
    var cal = {
        ...
        list: () => {
            ...
            cal.data = sessionStorage.getItem("cal-" + cal.sMth + "-" + cal.sYear);
            if (cal.data == null) {
                sessionStorage.setItem("cal-" + cal.sMth + "-" + cal.sYear, "{}");
                cal.data = {};
            } else {
        ...
        show: (el) => {
            ...
            cal.hfDate.innerHTML = `{$innerhtml2}`;
            if (isEdit) {
