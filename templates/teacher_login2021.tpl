                        ...
                        <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="pt-4 pb-2">
                                        <h5 class="card-title text-center pb-0 fs-4">Teacher<br>Login to Your Classroom
                                        </h5>
                                    ...
                                    <form class="row g-3 needs-validation" method="POST" action="indexteacher2021.php"
                                        novalidate>
                                        ...
                                        <div class="col-12">
                                            <p class="small mb-0">Don't have account? <a
                                                    href="smart2019_teacher_signup.html">&nbsp;&nbsp;Create a Teacher or
                                                    Parent
                                                    Account for Free</a></p>
