                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title">Remove Grade Level</h5>
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <a class="btn btn-danger"
                                            href="teacher_grademanagersearch2021.php?remove=true&id={$id}"
                                            role="button">Remove Grade Level</a>
                                    </div>
                                </div>
                            </div>
                        </div><!-- End Basic Modal-->
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Lessons &nbsp;&nbsp;<a class="btn btn-primary"
                                    href="teacher_grademanagersearch2021.php?add=true" role="button">Add Grade Level
                                </a></h5>
                    ...
                    <div class="card">
                        <div class="card-body pt-3">
                            ...
                            <div class="tab-pane fade show active profile-general" id="profile-general">
                                ...
                                <form action="teacher_grademanagersearch2021.php" method="post" id="tab_general">
