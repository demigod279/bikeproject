            ...
            <div class="row">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h5 class="card-title"> <a class="btn btn-primary"
                                            href="teacher_studentclassgrade2021.php?classno={$classno}&studentno={$studentno}&email=send"
                ...
                <div class="col-lg-4">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h5 class="card-title"> <a class="btn btn-primary"
                                    href="teacher_studentclassgrade2021.php?classno={$classno}&studentno={$studentno}&email=sendmissing"
