                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title">Remove Grade</h5>
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <a class="btn btn-danger"
                                            href="teacher_GradeChartsearch2021.php?remove=true&id={$id}"
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Lessons &nbsp;&nbsp;<a class="btn btn-primary"
                                    href="teacher_GradeChartsearch2021.php?add=true" role="button">Add Grade
                                </a></h5>
                    ...
                    <div class="card">
                        <div class="card-body pt-3">
                            ...
                            <div class="tab-pane fade show active profile-general" id="profile-general">
                                ...
                                <form action="teacher_GradeChartsearch2021.php" method="post" id="tab_general">

                                    <div class="row mb-3">
                                        <label for="company" class="col-md-4 col-lg-3 col-form-label">Grade
                                            (ABCDF)</label>
                                    ...
                                    <div class="row mb-3">
                                        <label for="company" class="col-md-4 col-lg-3 col-form-label">Percentage
                                            (Starting at) %</label>
                                        <div class="col-md-8 col-lg-9">
                                            {$general_percentage}
                                        </div>
