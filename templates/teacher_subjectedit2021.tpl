                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <a class="btn btn-danger"
                                            href="teacher_subjectedit2021.php?remove=true&subjectno={$subjectno}"
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Lessons &nbsp;&nbsp;<a class="btn btn-primary"
                                    href="teacher_subjectedit2021.php?add=true" role="button">Add Subject
                                </a></h5>
                    ...
                    <div class="card">
                        <div class="card-body pt-3">
                            ...
                            <div class="tab-pane fade show active profile-general" id="profile-general">
                                ...
                                <form action="teacher_subjectedit2021.php" method="post" id="tab_general">
