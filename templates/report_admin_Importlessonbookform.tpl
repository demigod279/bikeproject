...
<body>
  ...
  <div id="container">
    ...
    <h4 ><span><font size="45"><center>Lesson Book</center></span></font></h4> 
             </br> </br></br> </br>
            <!-- Classic Heading -->
             <center> <h1>{$LessonPlanLesson}</h1> </center>
            </br> </br>
            <h4><center>{$ClassNameInformation}</center></h4> 
            
            </br> </br></br> </br>
           <div class="profile-avatar">
                      <center>  <img src="{$LessonImage}" class="profile-avatar-img thumbnail" width="250" Height="250" alt="Lesson Image"></center>
                    </div> 
             </br> 
...
<h4 class="classic-title">Activity Sheet:</h4>{$LessonPlanNotes} </br> </br> 
 ...
 <p style="page-break-after: always;">&nbsp;</p>
<h4 class="classic-title">Student Lesson Study Notes: (Notes Students need to include in the Student Notebook)</h4>{$LessonPlanObjective} </br> </br> 

<p style="page-break-after: always;">&nbsp;</p>
        
<h4 class="classic-title">Lesson Exam:</h4>{$LessonExam} </br> </br> 



<p style="page-break-after: always;">&nbsp;</p>
        
<h4 class="classic-title">Lesson Exam Answers:</h4>{$LessonExamAnswers} </br> </br> 
