<?php /* Smarty version Smarty-3.1.21-dev, created on 2022-01-22 09:14:29
         compiled from ".\templates\student_concepttestview2021.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1237261ec3b7521d152-68873678%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b8d9b0917b9a195a2e68df5ad44ab59384659138' => 
    array (
      0 => '.\\templates\\student_concepttestview2021.tpl',
      1 => 1642806043,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1237261ec3b7521d152-68873678',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_61ec3b75389709_01358275',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_61ec3b75389709_01358275')) {function content_61ec3b75389709_01358275($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
...
<li class="nav-item">
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      ...
      <h1>Exam <?php echo $_smarty_tpl->tpl_vars['title']->value;?>
</h1>
      <nav>
        <ol class="breadcrumb">
...
">Lesson</a></li>
          <li class="breadcrumb-item active">Exam <?php echo $_smarty_tpl->tpl_vars['title']->value;?>
</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
 ...
 <div class="modal fade" id="verticalycenteredconcept" tabindex="-1">
  ...
  <div  id="myModalstory" class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
           ...
           <div class="modal-footer">Read Before Closing! &nbsp;&nbsp;&nbsp;
             <button type="button" class="btn btn-default" data-dismiss="modal" onclick="showhide();">Close</button>
          </div>
                  </br></br>
                </div>
              </div>
...
">
                           <div id="questionpost" style="display: block"> 
                               <?php echo $_smarty_tpl->tpl_vars['LastCorrect']->value;?>
                                ...
                                <h5>   <?php echo $_smarty_tpl->tpl_vars['PracticeQuestion']->value;?>
