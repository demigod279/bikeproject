...
$tsql = "select customer_id,first_name,last_name, email,street,street2,company_name,city,state,phone,alt_first_name,alt_last_name, alt_email,alt_street,alt_street2,alt_company_name,alt_city,alt_state,alt_phone,country,shipping_country from sales.customers where customer_id = '" . $customer_id . "'";
